...
@Component({
  ...
  standalone: true,
  template: `
    <div class="w-full max-w-[380px] mx-auto rounded-card border border-border p-5 shadow-card bg-cream/30">
      ...
      <div class="grid grid-cols-7 gap-1">
        @for (cell of grid(); track cell.dateStr + '-' + cell.day) {
          <div
            class="aspect-square min-w-0 flex items-center justify-center rounded-md text-sm font-sans font-medium transition-colors"
